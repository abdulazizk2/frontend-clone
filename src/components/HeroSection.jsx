...
const HeroSection = () => {
  return (
    <div className="mx-38 px-3 mt-20 items-center justify-center">
      <h1 className="capitalize text-2xl md:text-6xl font-semi-bold text-center w-11/12">
      ...
      <div className="hidden md:flex container items-center justify-between -mt-32">
