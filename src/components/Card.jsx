...
const Card = () => {
  return (
    <>
      <div className="mt-6 flex flex-col items-center md:flex-row gap-5 md:items-end md:justify-evenly mb-2 md:mb-28 w-full">
        <div className=" w-48 rounded-md bg-[url(https://images.pexels.com/photos/392031/pexels-photo-392031.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)] bg-cover group-hover:opacity-75 lg:h-64"></div>
        <div className="flex flex-col w-40 rounded-md bg-green-950 object-cover group-hover:opacity-75 lg:h-64 text-center items-center justify-center">
