...
const Card = () => {
  return (
    <>
      <div className="flex-col mt-6 items-center justify-center flex sm:flex-row sm:items-end sm:justify-evenly sm:container mb-28 w-full">
        ...
        <div className="flex flex-col w-[40%] sm:w-40 rounded-md bg-green-950 object-cover group-hover:opacity-75 lg:aspect-auto lg:h-64 text-center items-center justify-center">
