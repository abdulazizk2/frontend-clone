  ...
  return (
    <section className="container w-full bg-white text-center pt-7 rounded-md text-black pb-10">
      <div className="flex flex-col md:flex-row items-center justify-center gap-10 mt-20">
        ...
        <div className="w-full md:max-w-[45%] md:text-left"><h1 className="text-4xl mt-8 mb-5 capitalize">Key Benefits of our system for <span className="capitalize">your business efficiency</span></h1>
